...
class Level1 extends Phaser.Scene {
	...
	create() {
		...
		//Phaser.Physics.Matter.PointerConstraint(this);
		//Phaser.Physics.Matter.PointerConstraint
		var pointer = new Phaser.Physics.Matter.PointerConstraint(this, this.matter.world);

		this.matter.world.on('dragstart', (body, part, constraint) => {
			if (body.label != 'ball' && body.label != 'Level1Ground') {
				body.collisionFilter.group = -4;
			}
		})
