...
class Level1 extends Phaser.Scene {
	...
	editorCreate() {
		...
		// level1Hint
		const level1Hint = this.add.image(747, 495, "Level1Hint");
		...
		// pauseOut_png
		const pauseOut_png = this.add.image(68, 54, "uiButtons", "pauseOut.png");

		// hintOut_png
		const hintOut_png = this.add.image(168, 54, "uiButtons", "hintOut.png");
