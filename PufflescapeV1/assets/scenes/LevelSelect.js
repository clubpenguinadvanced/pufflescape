...
class LevelSelect extends Phaser.Scene {
	...
	editorCreate() {
		...
		// buttonW1Bottom4_png_1_1_1
		this.add.image(1221, 586, "buttons", "buttonW1Bottom4.png");

		// buttonW1Top1_png_1_1_1
		const buttonW1Top1_png_1_1_1 = this.add.image(1221, 506, "buttons", "buttonW1Top1.png");

		// text_2_1_1
		const text_2_1_1 = this.add.text(1116, 476, "", {});
		text_2_1_1.text = "Level4";
		text_2_1_1.setStyle({"color":"#0c57a9ff","fontSize":"36px","stroke":"#0c57a9ff","strokeThickness":4});
		...
		// buttonW1Top1_png_1_1_1 (components)
		new InteractiveObject(buttonW1Top1_png_1_1_1);
		const buttonW1Top1_png_1_1_1PointerHandler = new PointerHandler(buttonW1Top1_png_1_1_1);
		buttonW1Top1_png_1_1_1PointerHandler.texOver = "buttonW1Top2.png";
		buttonW1Top1_png_1_1_1PointerHandler.texOut = "buttonW1Top1.png";
		buttonW1Top1_png_1_1_1PointerHandler.texOn = "buttonW1Top3.png";
		const buttonW1Top1_png_1_1_1goToLevel = new goToLevel(buttonW1Top1_png_1_1_1);
		buttonW1Top1_png_1_1_1goToLevel.sceneKey = "Level4";
