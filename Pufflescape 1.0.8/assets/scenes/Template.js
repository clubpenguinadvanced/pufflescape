...
class Template extends Phaser.Scene {
	...
	editorCreate() {
		...
		// symbol_2_1
		const symbol_2_1 = this.add.image(1565, 1084, "Symbol 2");
		symbol_2_1.scaleX = 1.2226632606777537;
		symbol_2_1.scaleY = 1.2226632606777537;

		// rectangle
		const rectangle = this.add.rectangle(1550, 1111, 128, 128);
		rectangle.scaleX = 0.5836364623470147;
		rectangle.scaleY = 0.20127176681410605;
		rectangle.isFilled = true;

		// door
		const door = this.add.rectangle(1689, 767, 64, 350);
		door.isFilled = true;
		door.fillColor = 8788889;

		// exit
		const exit = this.add.rectangle(1834, 781, 128, 128);
		exit.isFilled = true;
		exit.fillColor = 8260620;

		// key
		const key = this.add.rectangle(1936, 515, 146, 78);
		key.isFilled = true;
		key.fillColor = 15521600;

		// rectangle_2
		const rectangle_2 = this.add.rectangle(1632, 398, 51, 82);
		rectangle_2.isFilled = true;
		rectangle_2.fillColor = 14649600;

		// rectangle_2_1
		const rectangle_2_1 = this.add.rectangle(1791, 395, 51, 82);
		...
		// text_1
		const text_1 = this.add.text(-969, 622, "", {});
